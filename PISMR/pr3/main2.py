...
class Link:
    def __init__(self, L=20, ang=0, pos=[0, 0]):
        ...
        self.min_ang, self.max_ang = -math.pi/2, math.pi/2 # NEW !!!
        self.global_ang = 0
...
class Robot:
    def __init__(self, x, y, alpha):
        ...
        self.last_da = 0
        self.manip = Manipulator(self.getPos(), 2, 45)
    ...
    def sim(self, dt):
        ...
        self.manip.set_base_ang(self.alpha)   # NEW ext_ang !!!
        self.manip.sim(dt)
...
if __name__ == "__main__":
    ...
    manip = Manipulator((200, 200), 7, 100)
    ...
    while True:
        ...
        robot.goto(goal, dt)
        robot.sim(dt)
        robot.manip.solve_ik(goal, robot.alpha)
